...
<body>
   ...
   <div class="container navContainer">
        <div class="row subContainer">
            ...
            <div class=" listContainer col-lg-8 col-md-12 col-xs-6 xs-pt-5">
               <ul class="items d-flex justify-content-center aligns-items-center">
                    <li class="col-xs-3"><a href="index.php">Home</a></li>
                    <li class="col-xs-3"><a href="">Results</a></li>
 ...
 <div class="container main-container">
    <div class="row">
        <div class=" firstContainer left col-lg-5 d-flex aligns-items-center justify-content-center">
            <section class="secContainer">
                <h3 class="d-flex aligns-items-center justify-content-center">ICFAI Student Management System</h3>
                ...
                <div class="row mainbtnContainer">
                    <div class="col-lg-4 col-md-6 col-sm-6 btnContainer ">
                        <button class="btnn"> &nbsp &nbsp Moachuba &nbsp &nbsp</button>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 btnContainer ">
                        <button class="btnn">&nbsp &nbsp Log out &nbsp &nbsp</button>
                    </div>
                </div>
                <br>
            </section>
