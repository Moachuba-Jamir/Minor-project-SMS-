        ...
        <div class="row formContainer ">
            <div class=" formClass col-lg-6 col-lg-offset-6 col-md-offset-5 col-sm-offset-7 col-xs-offset-4">
                    ...
                    <form action="" method="POST">
                        <input type="text" name="user_name" placeholder="Provide a username..." required>
                        <br>
                        <br>
                        <input type="text" name="enrol" placeholder="Enter your Enrollment no..." required>
                        <br>
                        <br>
                        <input type="password" name="pwd" placeholder="Password..."required>
                        <br>
                        <br>
                        <input type ="submit" value="Sign up" class="btn btnn">
